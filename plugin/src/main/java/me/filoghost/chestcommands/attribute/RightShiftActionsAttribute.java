...
public class RightShiftActionsAttribute implements IconAttribute {

    private final List<Action> actions;

    public RightShiftActionsAttribute(List<String> serializedActions, AttributeErrorHandler errorHandler) {
    ...
    public void apply(InternalConfigurableIcon icon) {
        icon.setRightShiftActions(actions);
    }
