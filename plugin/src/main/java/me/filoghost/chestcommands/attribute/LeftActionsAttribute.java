...
public class LeftActionsAttribute implements IconAttribute {

    private final List<Action> actions;

    public LeftActionsAttribute(List<String> serializedActions, AttributeErrorHandler errorHandler) {
