...
public class LeftShiftActionsAttribute implements IconAttribute {

    private final List<Action> actions;

    public LeftShiftActionsAttribute(List<String> serializedActions, AttributeErrorHandler errorHandler) {
    ...
    public void apply(InternalConfigurableIcon icon) {
        icon.setLeftShiftActions(actions);
    }
